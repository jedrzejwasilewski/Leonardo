...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
back=pygame.image.load("C:\\Users\\Martynka\\Desktop\\bgrnd.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        wybor=int(input())
        if wybor==1:
            self.surf = pygame.image.load("C:\\Users\\Martynka\\Desktop\\g6.png").convert()
            self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        elif wybor==2:
            self.surf = pygame.image.load("C:\\Users\\Martynka\\Desktop\\g5.png").convert()
            self.surf.set_colorkey((0, 0, 0), RLEACCEL)
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:\\Users\\Martynka\\Desktop\\laczek.png").convert()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        self.rect = self.surf.get_rect(
            center=(
...
class Babcia(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:\\Users\\Martynka\\Desktop\\babcia1.png").convert()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        self.rect = self.surf.get_rect()
    def update(self):
...
class Owoc(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:\\Users\\Martynka\\Desktop\\japko.png").convert()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        self.rect = self.surf.get_rect(
...
class new_platform(pygame.sprite.Sprite):
    def __init__(self, x, y, w, h):
        ...
        self.surf = pygame.image.load("C:\\Users\\Martynka\\Desktop\\platform1.png")
...
# platforms = [new_platform(0, 30, 60, 100), new_platform(80, 120, 150, 200)]
platforms = pygame.sprite.Group()
P1 = new_platform(0, 30, 60, 100)
P2 = new_platform(80, 120, 150, 200)
platforms.add(P1)
platforms.add(P2)
...
# Add a new enemy?
    ...
    # hits = False
    # if hits == False and pygame.sprite.spritecollideany(player, platforms):
    #     hits = True
    #     player.rect.midbottom = hits[0].rect.top
    # if hits == True and not pygame.sprite.spritecollideany(player, platforms):
    #     hits = False

# def obstacleHit_or_not(self, player, platforms):
#     for platform in platforms:
#         hit = pygame.sprite.collide_rect(player, platforms)
#         if hit:
#              player.midbottom = hits[0].rect.top
    # return False
    ...
    #     all_sprites.update()
        ...
        # if hits == False and pygame.sprite.spritecollideany(player, platforms):
        #     hits = True
            # player.pos.midbottom = hits[0].rect.top
        #

    # if hits:
    #     player.pos.y = hits[0].rect.top #nie wiem jak można by to przerobić na nasze potzreby bo tu jest wymagana intwerwencja w playera
    #     player.vel.y = 0 # gracz nie przenika ale sie zatrzymuje

    # hits = pygame.sprite.spritecollide(player, platforms, False)
    # if hits:
    #     player = hits[0].rect.top #nie wiem jak można by to przerobić na nasze potzreby bo tu jest wymagana intwerwencja w playera
    # # self.player.vel.y = 0 # gracz nie przenika ale sie zatrzymuje
