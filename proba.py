...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
back=pygame.image.load("C:/Users/Dwala/Desktop/Leonardo/bgrnd.png")
# Define a Player object by extending pygame.sprite.Sprite
# The surface drawn on the screen is now an attribute of 'player'
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super(Player, self).__init__()
        self.surf = pygame.image.load("C:/Users/Dwala/Desktop/Leonardo/1.png").convert()
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:/Users/Dwala/Desktop/Leonardo/laczek.png").convert()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        self.rect = self.surf.get_rect(
            center=(
...
class Babcia(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:/Users/Dwala/Desktop/Leonardo/babcia1.png").convert()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        self.rect = self.surf.get_rect()
    def update(self):
...
class Owoc(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("C:/Users/Dwala/Desktop/Leonardo/jablko.png").convert()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        self.jablka = 5
    def get_jablka(self):
        return self.jablka
...
class platform(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Dwala/Desktop/Leonardo/platform1.png")
